  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-10 left-1/2 w-72 h-72 bg-indigo-600 rounded-full mix-blend-multiply filter blur-3xl opacity-20 animate-glow-pulse" style={{ animationDelay: '2s' }}></div>
      </div>
      ...
      <div className="relative z-10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="animate-float-up">
              ...
              <p className="text-xl text-gray-300 mb-8 leading-relaxed">
                A modern platform for developers to save, organize, and share their favorite code snippets. Never lose a useful piece of code again.
              </p>
              ...
              <div className="space-y-4 mb-8">
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-gray-400">Save code snippets with syntax highlighting in seconds</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Code2 className="w-6 h-6 text-blue-400 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Multiple Languages</h3>
                    <p className="text-gray-400">Support for all popular programming languages</p>
                  </div>
                </div>
                <div className="flex items-start gap-3">
                  <Share2 className="w-6 h-6 text-indigo-400 mt-1 flex-shrink-0" />
                  <div>
                    <h3 className="font-semibold text-lg mb-1">Easy Organization</h3>
                    <p className="text-gray-400">Organize snippets with tags and descriptions</p>
                  </div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/snippets">
                  <Button size="lg" className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white border-0 group animate-glow-pulse">
                    Get Started
                    <ArrowRight className="w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
                  </Button>
                </Link>
                <Button size="lg" variant="outline" className="border-purple-400/50 text-white hover:bg-purple-400/10 bg-transparent">
                  Learn More
                </Button>
              </div>
            </div>
              ...
              <div className="relative">
                ...
                <div className="relative bg-slate-800/50 backdrop-blur-xl border border-purple-500/20 rounded-2xl p-8">
                  <div className="space-y-4">
                    <div className="h-3 bg-gradient-to-r from-purple-500 to-blue-500 rounded w-32"></div>
        ...
        {/* Stats Section */}
        <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 grid grid-cols-3 gap-8 text-center">
        ...
        <section className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center">
          <div className="bg-gradient-to-r from-purple-600/20 to-blue-600/20 border border-purple-500/30 rounded-2xl p-12 backdrop-blur-xl">
            <h3 className="text-3xl font-bold mb-4">Ready to organize your code?</h3>
            <p className="text-gray-300 mb-8">Join thousands of developers who trust Codely for their code snippet management.</p>
            <Link href="/snippets">
