					...
					<div className='grid grid-cols-1 md:grid-cols-2 gap-12 items-center'>
						...
						<div className='animate-float-up'>
							...
							<p className='text-xl text-gray-300 mb-8 leading-relaxed'>
								A modern platform for developers to save, organize, and
								share their favorite code snippets. Never lose a useful
								piece of code again.
							</p>
								...
								<div className='flex items-start gap-3'>
									...
									<div>
										...
										<p className='text-gray-400'>
											Save code snippets with syntax highlighting in
											seconds
										</p>
									</div>
								</div>
							...
							<div className='flex flex-col sm:flex-row gap-4'>
								<Link href='/snippets'>
									<Button
										size='lg'
										className='bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white border-0 group animate-glow-pulse'>
										Get Started
								...
								<Button
									size='lg'
									variant='outline'
									className='border-purple-400/50 text-white hover:bg-purple-400/10 bg-transparent'>
									Learn More
								</Button>
							</div>
						</div>
				...
				<section className='max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-20 text-center'>
					<div className='bg-gradient-to-r from-purple-600/20 to-blue-600/20 border border-purple-500/30 rounded-2xl p-12 backdrop-blur-xl'>
						...
						<p className='text-gray-300 mb-8'>
							Join thousands of developers who trust Codely for their
